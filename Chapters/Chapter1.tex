...
\end{enumerate*}
There are three types of spatial query supported by the LSPH: point quey, range query and KNN query. In addition to handling spatial points, the LSPH is also supporting a minimum bounding box. Therefore, the LSPH is addressing some disadvantages of existing learned indexes and it has obtained interesting performance results compared to other methods.  
