...
\subsection{Datasets} 
As shown in the Table \ref{table:datasets} above, we have two real world datasets the \texttt{post} \cite{rtreeportal} and \texttt{osm} \cite{OpenStreetMap}, and one synthetic dataset the \texttt{g2} \cite{G2sets}. Figure \ref{fig:datasets} illustrates the general size and distribution of each dataset. 
...
Figure \ref{fig:performance} illustrates the overall performance of all indexes. 
